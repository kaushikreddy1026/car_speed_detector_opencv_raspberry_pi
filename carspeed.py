...
MIN_SPEED = 20  #<---- enter the minimum speed for saving images
            ...
            if state == TRACKING:       
                ...
                if ((x <= 2) and (direction == RIGHT_TO_LEFT)) \
                    ...
                    if (last_mph > MIN_SPEED):    # save the image
                        ...
                        send_email.send_email(imageName=imageFilename)
                        if SAVE_CSV:
                    ...
                    state = SAVING
                    #TODO SRINIVAS AND ABHISAR 
                    # invoke the function defined in send_email and pass in imageFilename as the argument.
